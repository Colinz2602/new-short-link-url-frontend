    ...
    return (
        <div className="bg-white p-4 rounded-xl shadow-lg border-l-4 border-teal-400 animate-in slide-in-from-bottom-2 fade-in duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button
                    onClick={handleCopy}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition shadow-sm w-full md:w-auto justify-center ${copied
    ...
    return (
        <div className="max-w-xl space-y-4">
            ...
            <p className="mt-4 text-sm text-gray-500">
                * Sign in to shorten more links and manage them easily.
            </p>
        </div>
    );
}
